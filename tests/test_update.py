...
def test_update(noisy_model):
    ...
    assert value == state.detector.variance.value
    assert scale == state.ice.variance.scale
    ...
    assert value == model.state.detector.variance.value
    assert scale == model.state.ice.variance.scale
