...
def test_default_pose_images(noiseless_model):
    ...
    model_euler = eqx.tree_at(lambda m: m.scattering_theory.potential_ensemble.pose, noiseless_model, euler)
    model_quat = eqx.tree_at(lambda m: m.scattering_theory.potential_ensemble.pose, noiseless_model, quat)
